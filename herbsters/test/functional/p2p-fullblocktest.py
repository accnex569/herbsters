...
This reimplements tests from the herbstersj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure herbstersd isn't accepting b26
        ...
        # Extend the b28 chain to make sure herbstersd isn't accepting b28
        ...
        # A block with timestamp > 2 herbs in the future
        tip(44)
        ...
        #    Low-S and High-S values (whereas the herbsters code has custom code which does so);
